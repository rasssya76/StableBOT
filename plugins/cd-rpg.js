...
⛔ *Banned:* No
`.trim()
    await conn.sendMessage(m.chat, { text: str, contextInfo: { externalAdReply: { title: `GAME`, thumbnailUrl: pp, mediaType: 1, renderLargerThumbnail: true }}}, { quoted: m})
 //conn.sendFile(m.chat, pp, null, str, m)
}
