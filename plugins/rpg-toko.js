                ...
                case 'foodpet':
                    ...
                    case 'potion':
                            if (global.db.data.users[m.sender].money >= potion * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Potion 🥤 Dengan Harga ${potion * count} money 💹\n\n📍 Gunakan Potion Dengan Ketik: *${usedPrefix}use potion <jumlah>*`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Potion Dengan Harga ${potion * count} Money `,)
                        break
                    case `gold`:
                            ...
                            conn.reply(m.chat, `Sukses Membeli ${toSimpl(count)} Gold 🪙 Dengan Harga ${Bgold * count} money`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Gold Dengan Harga ${Bgold * count} Money `,)
                        break
                    case 'bibitmangga':
                            ...
                            conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Bibit Mangga 🌾\nDengan Harga ${Bapel * count} money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Bibit Mangga 🌾\nDengan Harga ${Bapel * count} Money 💹`,)
                        break
                    case 'bibitapel':
                            ...
                            conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Bibit Apel🌾\nDengan Harga ${Bapel * count} money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Bibit Apel 🌾\nDengan Harga ${Bapel * count} Money 💹`,)
                        break
                    case 'bibitjeruk':
                            if (global.db.data.users[m.sender].money >= Bapel * count) {
                            global.db.data.users[m.sender].money -= Bapel* count
                            global.db.data.users[m.sender].bibitjeruk += count * 1
                            conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Bibit Jeruk🌾\nDengan Harga ${Bapel * count} money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Bibit Jeruk 🌾\nDengan Harga ${Bapel * count} Money 💹`,)
                        break
                     case 'bibitpisang':
                            if (global.db.data.users[m.sender].money >= Bapel * count) {
                            global.db.data.users[m.sender].money -= Bapel* count
                            global.db.data.users[m.sender].bibitpisang += count * 1
                            conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Bibit Pisang🌾\nDengan Harga ${Bapel * count} money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Bibit Pisang 🌾\nDengan Harga ${Bapel * count} Money 💹`,)
                        break
                    case 'bibitanggur':
                            if (global.db.data.users[m.sender].money >= Bapel * count) {
                            global.db.data.users[m.sender].money -= Bapel* count
                            global.db.data.users[m.sender].bibitanggur += count * 1
                            conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Bibit Anggur🌾\nDengan Harga ${Bapel * count} money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Bibit Anggur 🌾\nDengan Harga ${Bapel * count} Money 💹`,)
                        break
                    case 'diamond':
                            if (global.db.data.users[m.sender].money >= Bdiamond * count) {
                                global.db.data.users[m.sender].diamond += count * 1
                                global.db.data.users[m.sender].money -= Bdiamond * count
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Diamond 💎 Dengan Harga ${Bdiamond * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                    case 'batu':
                           if (global.db.data.users[m.sender].money >= Bbatu * count) {
                               ...
                               conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Batu 🪨 Dengan Harga ${Bbatu * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                    case 'umpan':
                           if (global.db.data.users[m.sender].money >= Bumpan * count) {
                               ...
                               conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Umpan 🪱 Dengan Harga ${Bumpan * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                    case 'kayu':
                            if (global.db.data.users[m.sender].money >= Bkayu * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Kayu 🪵 Dengan Harga ${Bkayu * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                     case 'aqua':
                            if (global.db.data.users[m.sender].money >= Baqua * count) {
                                ...
                                global.db.data.users[m.sender].money -= Bkayu * count
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Aqua 🍶 Dengan Harga ${Baqua * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                    case 'string':
                            if (global.db.data.users[m.sender].money >= Bstring * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} String 🕸️ Dengan Harga ${Bstring * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                    case 'iron':
                           if (global.db.data.users[m.sender].money >= Biron * count) {
                               ...
                               conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Iron ⛓️ Dengan Harga ${Biron * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                    case 'common':
                            if (global.db.data.users[m.sender].money >= Bcommon * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Common Crate 📦 Dengan Harga ${Bcommon * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Common Crate 📦 Dengan Harga ${Bcommon * count} Money 💹 \n\n📍 Buka Crate Dengan Ketik: *${usedPrefix}open common*`, m)
                    ...
                    case 'uncommon':
                            if (global.db.data.users[m.sender].money >= Buncommon * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Uncommon Crate Dengan Harga ${Buncommon * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Uncommon Crate 🛍️ Dengan Harga ${Buncommon * count} Money 💹\n\n📍 Buka Crate Dengan Ketik: *${usedPrefix}open uncommon*`, m)
                    ...
                    case 'mythic':
                            if (global.db.data.users[m.sender].money >= Bmythic * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Mythic Crate 🎁 Dengan Harga ${Bmythic * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Mythic Crate 🎁 Dengan Harga ${Bmythic* count} Money\n\n📍 Buka Crate Dengan Ketik:*${usedPrefix}open mythic*`, m)
                    ...
                    case 'legendary':
                            if (global.db.data.users[m.sender].money >= Blegendary * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Legendary Crate 🧰 Dengan Harga ${Blegendary * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Legendary Crate 🧰 Dengan Harga ${Blegendary * count} Money  💹\n\n📍 Buka Crate Dengan Ketik: *${usedPrefix}open legendary*`, m)
                    ...
                    case 'pet':
                            if (global.db.data.users[m.sender].money >= Bpet * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Pet Crate 📫 Dengan Harga ${Bpet * count} Money 💹`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Pet Crate 📫 Dengan Harga ${Bpet * count} Money  💹\n\n📍 Buka Crate Dengan Ketik: *${usedPrefix}open legendary*`, m)
                    ...
                    case 'sampah':
                            if (global.db.data.users[m.sender].money >= Bsampah * count) {
                                ...
                                conn.reply(m.chat, `✔️ Sukses Membeli ${toSimpl(count)} Sampah 🗑️ Dengan Harga ${Bsampah * count} Money 💹 `, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Sampah 🗑️ Dengan Harga ${Bsampah * count} Money 💹`.trim(), m)
                ...
                switch (_type) {
                    case 'potion':
                        if (global.db.data.users[m.sender].potion >= count * 1) {
                            ...
                            global.db.data.users[m.sender].potion -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Potion 🥤 Dengan Harga ${Spotion * count} Money 💹 `.trim(), m)
                    ...
                    case 'gold':
                        if (global.db.data.users[m.sender].gold >= count * 1) {
                            ...
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Gold 🪙 Dengan Harga ${Sgold * count} Money 💹`.trim(), m)
                    ...
                    case 'arloji':
                        if (global.db.data.users[m.sender].arlok >= count * 1) {
                            ...
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Arloji 🧭 Dengan Harga ${Sarloji * count} Money 💹`.trim(), m)
                    ...
                    case 'batu':
                        if (global.db.data.users[m.sender].batu >= count * 1) {
                            ...
                            global.db.data.users[m.sender].batu -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Batu 🪨 Dengan Harga ${Sbatu * count} Money 💹`.trim(), m)
                    ...
                    case 'kayu':
                        if (global.db.data.users[m.sender].kayu >= count * 1) {
                            ...
                            global.db.data.users[m.sender].kayu -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Kayu 🪵 Dengan Harga ${Skayu * count} Money 💹`.trim(), m)
                    ...
                    case 'string':
                        if (global.db.data.users[m.sender].string >= count * 1) {
                            ...
                            global.db.data.users[m.sender].string -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} String 🕸️ Dengan Harga ${Sstring * count} Money 💹`.trim(), m)
                    ...
                    case 'iron':
                        if (global.db.data.users[m.sender].iron >= count * 1) {
                            ...
                            global.db.data.users[m.sender].iron -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Iron ⛓️ Dengan Harga ${Siron * count} Money 💹`.trim(), m)
                    ...
                    case 'common':
                        if (global.db.data.users[m.sender].common >= count * 1) {
                            ...
                            global.db.data.users[m.sender].common -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Common Crate 📦 Dengan Harga ${Scommon * count} Money 💹`.trim(), m)
                    ...
                    case 'uncommon':
                        if (global.db.data.users[m.sender].uncommon >= count * 1) {
                            ...
                            global.db.data.users[m.sender].uncommon -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Uncommon Crate 🛍️ Dengan Harga ${Suncommon * count} Money 💹`.trim(), m)
                    ...
                    case 'mythic':
                        if (global.db.data.users[m.sender].mythic >= count * 1) {
                            ...
                            global.db.data.users[m.sender].mythic -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Mythic Crate 🎁 Dengan Harga ${Smythic * count} Money 💹`.trim(), m)
                    ...
                    case 'legendary':
                        if (global.db.data.users[m.sender].legendary >= count * 1) {
                            ...
                            global.db.data.users[m.sender].legendary -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Legendary Crate 🧰 Dengan Harga ${Slegendary * count} Money 💹`.trim(), m)
                     ...
                     case 'pet':
                        if (global.db.data.users[m.sender].pet >= count * 1) {
                            ...
                            global.db.data.users[m.sender].pet -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Pet Crate 📫 Dengan Harga ${Spet * count} Money 💹`.trim(), m)
                    ...
                    case 'sampah':
                        if (global.db.data.users[m.sender].sampah >= count * 1) {
                            ...
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Sampah 🗑️ Dengan Harga ${Ssampah * count} Money 💹`, m)
                    ...
                    case 'diamond':
                        if (global.db.data.users[m.sender].diamond >= count * 1) {
                            ...
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Diamond 💎 Dengan Harga ${Sdiamond * count} Money 💹`, m)
                     ...
                     case 'mangga':
                        if (global.db.data.users[m.sender].mangga >= count * 1) {
                            ...
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Mangga 🥭 Dengan Harga ${Smangga * count} Money 💹`, m)
                     ...
                     case 'apel':
                        if (global.db.data.users[m.sender].apel >= count * 1) {
                            ...
                            global.db.data.users[m.sender].money += Smangga * count
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Apel 🍎 Dengan Harga ${Smangga * count} Money 💹`, m)
                     ...
                     case 'jeruk':
                        if (global.db.data.users[m.sender].jeruk >= count * 1) {
                            ...
                            global.db.data.users[m.sender].money += Smangga * count
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Jeruk 🍊 Dengan Harga ${Smangga * count} Money 💹`, m)
                     ...
                     case 'anggur':
                        if (global.db.data.users[m.sender].anggur >= count * 1) {
                            ...
                            global.db.data.users[m.sender].money += Smangga * count
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Anggur 🍇 Dengan Harga ${Smangga * count} Money 💹`, m)
                     ...
                     case 'pisang':
                        if (global.db.data.users[m.sender].pisang >= count * 1) {
                            ...
                            global.db.data.users[m.sender].money += Smangga * count
                            conn.reply(m.chat, `✔️ Sukses Menjual ${toSimpl(count)} Pisang 🍌 Dengan Harga ${Smangga * count} Money 💹`, m)
            ...
            switch (type) {
                case 'potion':
                        if (global.db.data.users[m.sender].money >= potion * count) {
                            global.db.data.users[m.sender].money -= potion * count
                            global.db.data.users[m.sender].potion += count * 1
                            conn.reply(m.chat, `Sukses membeli ${toSimpl(count)} Potion Dengan Harga ${potion * count} Money \n\nGunakan Potion Dengan Ketik: *${usedPrefix}use potion <jumlah>*`, m)
                        } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Potion Dengan Harga ${potion * count} Money`,m)
                ...
                case 'tprem':
                            if (global.db.data.users[m.sender].money >= Btprem * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${toSimpl(count)} Tiket Premium Dengan Harga ${Btprem * count} Money`, m)
                            } else conn.reply(m.chat, `Uang Anda Tidak Cukup`, m)
                        break
                case 'diamond':
                        if (global.db.data.users[m.sender].money >= Bdiamond * count) {
                            global.db.data.users[m.sender].diamond += count * 1
                            global.db.data.users[m.sender].money -= Bdiamond * count
                            conn.reply(m.chat, `Sukses Membeli ${toSimpl(count)} Diamond Dengan Harga ${Bdiamond * count} Money `, m)
                ...
                case 'common':
                        if (global.db.data.users[m.sender].money >= Bcommon * count) {
                            global.db.data.users[m.sender].common += count * 1
                            global.db.data.users[m.sender].money -= Bcommon * count
                            conn.reply(m.chat, `Sukses Membeli ${toSimpl(count)} Common Crate Dengan Harga ${Bcommon * count} Money `, m)
                        } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Common Crate Dengan Harga ${Bcommon * count} Money \n\nBuka Crate Dengan Ketik : *${usedPrefix}open common*`, m)
                ...
                case 'uncommon':
                        if (global.db.data.users[m.sender].money >= Buncommon * count) {
                            global.db.data.users[m.sender].uncommon += count * 1
                            global.db.data.users[m.sender].money -= Buncommon * count
                            conn.reply(m.chat, `Sukses Membeli ${toSimpl(count)} Uncommon Crate Dengan Harga ${Buncommon * count} Money `, m)
                        } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Uncommon Crate Dengan Harga ${Buncommon * count} Money \n\nBuka Crate Dengan Ketik: *${usedPrefix}open uncommon*`, m)
                ...
                case 'mythic':
                        if (global.db.data.users[m.sender].money >= Bmythic * count) {
                            global.db.data.users[m.sender].mythic += count * 1
                            global.db.data.users[m.sender].money -= Bmythic * count
                            conn.reply(m.chat, `Sukses Membeli ${toSimpl(count)} Mythic Crate Dengan Harga ${Bmythic * count} Money `, m)
                        } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Mythic Crate Dengan Harga ${Bmythic* count} money\n\nBuka Crate Dengan Ketik: *${usedPrefix}open mythic*`, m)
                ...
                case 'legendary':
                        if (global.db.data.users[m.sender].money >= Blegendary * count) {
                            global.db.data.users[m.sender].legendary += count * 1
                            global.db.data.users[m.sender].money -= Blegendary * count
                            conn.reply(m.chat, `Sukses Membeli ${toSimpl(count)} Legendary Crate Dengan Harga ${Blegendary * count} Money`, m)
                        } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Legendary Crate Dengan Harga ${Blegendary * count} Money \n\nBuka Crate Dengan Ketik: *${usedPrefix}open legendary*`, m)
                ...
                case 'sampah':
                        if (global.db.data.users[m.sender].money >= Bsampah * count) {
                            global.db.data.users[m.sender].sampah += count * 1
                            global.db.data.users[m.sender].money -= Bsampah * count
                            conn.reply(m.chat, `Sukses Membeli ${toSimpl(count)} Sampah Dengan Harga ${Bsampah * count} money`, m)
                        } else conn.reply(m.chat, `Uang Anda Tidak Cukup Untuk Membeli ${toSimpl(count)} Sampah Dengan Harga ${Bsampah * count} Money `.trim(), m)
            ...
            switch (type) {
                case 'potion':
                    if (global.db.data.users[m.sender].potion >= count * 1) {
                        global.db.data.users[m.sender].money += Spotion * count
                        global.db.data.users[m.sender].potion -= count * 1
                        conn.reply(m.chat, `Sukses Menjual ${toSimpl(count)} Potion Dengan Harga ${Spotion * count} Money`.trim(), m)
                    } else conn.reply(m.chat, `Potion Kamu Tidak Cukup `.trim(), m)
                    break
                case 'common':
                    if (global.db.data.users[m.sender].common >= count * 1) {
                        global.db.data.users[m.sender].money += Scommon * count
                        global.db.data.users[m.sender].common -= count * 1
                        conn.reply(m.chat, `Sukses Menjual ${toSimpl(count)} Common Crate Dengan Harga ${Scommon * count} Money`.trim(), m)
                    } else conn.reply(m.chat, `Common Crate Kamu Tidak Cukup `.trim(), m)
                    break
                case 'uncommon':
                    if (global.db.data.users[m.sender].uncommon >= count * 1) {
                        global.db.data.users[m.sender].money += Suncommon * count
                        global.db.data.users[m.sender].uncommon -= count * 1
                        conn.reply(m.chat, `Sukses Menjual ${toSimpl(count)} Uncommon Crate Dengan Harga ${Suncommon * count} Money`.trim(), m)
                ...
                case 'mythic':
                    if (global.db.data.users[m.sender].mythic >= count * 1) {
                        global.db.data.users[m.sender].money += Smythic * count
                        global.db.data.users[m.sender].mythic -= count * 1
                        conn.reply(m.chat, `Sukses Menjual ${toSimpl(count)} Mythic Crate Dengan Harga ${Smythic * count} Money`.trim(), m)
                    } else conn.reply(m.chat, `Mythic Crate Kamu Tidak Cukup `.trim(), m)
                    break
                case 'legendary':
                    if (global.db.data.users[m.sender].legendary >= count * 1) {
                        global.db.data.users[m.sender].money += Slegendary * count
                        global.db.data.users[m.sender].legendary -= count * 1
                        conn.reply(m.chat, `Sukses Menjual ${toSimpl(count)} Legendary Crate Dengan Harga ${Slegendary * count} Money`.trim(), m)
                    } else conn.reply(m.chat, `Legendary Crate Kamu Tidak Cukup`.trim(), m)
                    break
                case 'sampah':
                    if (global.db.data.users[m.sender].sampah >= count * 1) {
                        global.db.data.users[m.sender].sampah -= count * 1
                        global.db.data.users[m.sender].money += Ssampah * count
                        conn.reply(m.chat, `Sukses Menjual ${toSimpl(count)} Sampah, Dan Anda Mendapatkan ${Ssampah * count} Money`.trim(), m)
                ...
                case 'diamond':
                    if (global.db.data.users[m.sender].diamond >= count * 1) {
                        global.db.data.users[m.sender].diamond -= count * 1
                        global.db.data.users[m.sender].money += Sdiamond * count
                        conn.reply(m.chat, `Sukses Menjual ${toSimpl(count)} Diamond, Dan Anda Mendapatkan ${Sdiamond * count} Money`, m)
                    } else conn.reply(m.chat, `Diamond Anda Tidak Cukup `, m)
                    break
                default:
                    return conn.reply(m.chat, Kchat, m, { contextInfo: { externalAdReply: { showAdAttribution: true,
